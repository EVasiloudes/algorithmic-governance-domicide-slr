...
\begin{titlepage}
  ...
  \vspace{0.5cm}
  {\large Student ID Number (GUID): 3069953V \par}
  \vspace{1.5cm}
  {\large Presented in partial fulfilment of the requirements for the degree of \programme \par}
  \vspace{1cm}
  {\large Supervised by \supervisorname \par}
  \vspace{1cm}
  {\large Word Count: 14,756 (main body) \par}
  \vspace{0.5cm}
