...
\caption{The systematic map. Two well-documented literatures run in parallel --- algorithmic urban governance (Search A) and spatial destruction (Search B) --- with the junction of algorithmically mediated urbicide substantively addressed by only five records of 275, all published since 2021.}
