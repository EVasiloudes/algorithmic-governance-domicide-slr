...
\begin{tabular}{lcccc}
\toprule
\textbf{Theme} & \textbf{Search A (n=126)} & \textbf{Search B (n=21)} & \textbf{Snowball (n=123)} & \textbf{Combined (n=270)} \\
\midrule
...
The predictive-policing literature ($\sim$22 records) has matured into a genuine epistemology of algorithmic governance. \textcite[p.~2]{kaufmann2019} states the core problem cleanly: patterns are ``the epistemological core of predictive policing,'' and ``the clean surface of the pattern makes it impossible to defend oneself against their results.'' Studies of specific systems show political choices being laundered into code: Rio's CrimeRadar naturalises its designers' assumptions ``in the process of translating crime events into strings of codes, datasets, and maps'' \parencite{duarte2021}; the pattern's authority is rearticulated with each technical generation \parencite{halterlein2021}. Ethnographic work complicates the automation story from inside: Bogotá police ``corrupt'' crime data at input through institutional cultures \parencite{barreneche2019}; LAPD officers dismiss risk scores as ``witchcraft'' \parencite{brayne2020} while nonetheless being governed by them.

\subsection{Opacity is manufactured, not inherited}

The second finding reframes the black box. Across legal and policy records ($\sim$15), opacity is not a technical property of machine learning but an institutional product: trade secrecy asserted by vendors \parencite{brayne2020}, procurement frameworks where ``opacity is normalised as a feature and not a bug'' \parencite{article19_2022}, and statutory carve-outs that exempt national security from transparency law — the LED and AI Act ``fail to lift the `veil of secrecy''' \parencite[p.~22]{erdogan2024}, whose individualised remedies ``cannot correspond to effects of AI technologies at a population-level.'' EPIC's amicus work \parencite{epic2026} catches the resulting bind: automated license plate recognition (ALPR) decisions are ``cloaked in objectivity and hidden in a proprietary black box,'' making constitutional and legal oversight structurally impossible — as EPIC's Fourth Amendment framing demonstrates for the US context, and as \textcite{erdogan2024} extends to the European regulatory framework. The implication for the framework: technical transparency fixes (explainable AI, audits) recur in the corpus as necessary but radically insufficient, because the box is legal before it is computational.
...
A bridging motif recurs across all three: the view from above as an epistemic position — the ``God's Eye View'' \parencite{monroe2017}, the drone's ``cosmic view'' \parencite{wall2011}, the helicopter's ``verticalized omniscience'' \parencite{adey2010}, Graham's \parencite{graham2012} machinic ``Id-ing'' replacing social identification. Epistemic authority in this literature is literalised as altitude. Theme~4 shows what that altitude is for.
...
Yet the algorithmic mode of destruction is the theme's thinnest cluster. Five records in the coded corpus of 270 substantively address algorithmically mediated spatial destruction — four published since 2021, the fifth a precursor from 2008. Because these five constitute the review's most direct evidence at the junction the framework predicts, each is taken in turn.

\textbf{The precursor: \textcite{graham2008}.} Writing fifteen years before the current wave, Graham reads DARPA's Combat Zones That See programme as the blueprint for the algorithmically targeted city. The programme's ambition was to ``saturate'' global-South cities ``with myriads of networked surveillance systems,'' building ``fully representative data profiles on the `normal' time-space movement patterns of entire subject cities'' so that algorithms could flag the abnormal. Graham's point, made before the smart city had a name, is that the military's dream of total urban dominance with minimal friendly casualties required precisely the data infrastructure that smart urbanism would later naturalise: continuous, population-scale, machine-readable modelling of urban life. The record is the corpus's earliest statement that the targetable city and the optimised city are the same city.

\textbf{The epistemic mechanism: \textcite{zavrsnik2021}.} Zavr{\v{s}}nik and Badali{\v{c}}'s analysis of the automation of crime prevention, surveillance, and military operations — including a dissection of Project Maven, the Pentagon's flagship computer-vision programme — supplies the epistemic link. Their central claim is that automation changes knowledge production itself: ``Algorithmic vision produces a reality from which to act,'' rather than merely representing one. Applied to targeting, this relocates destruction upstream: the kill chain begins not with the strike but with the categories — person of interest, pattern of life — that make targets thinkable. The record connects Theme~2 and Theme~4 explicitly: the black box is not adjacent to the violence; it is the violence's first stage.

\textbf{The kill list: \textcite{hourani2024}.} Hourani's account of war, reconstruction, and the city contains the corpus's most direct documentation of algorithmically mediated killing: Israel's Lavender and Where's Daddy? systems, which generate targets at scale and track them ``to their homes, where they are killed along with their families'' — a practice that ``gives lie to technophilic dreams of the sanitary smart bomb.'' Hourani situates these systems within the post-conflict-catastrophe complex, the cyclical logic (\S\ref{sec:theme4}) by which destruction and reconstruction continue the same war. The systems, Hourani warns, ``may be indicative of what's to come'': mass-produced targeting as a standing capability rather than an emergency measure.

\textbf{The counter-proof: \textcite{holail2024}.} The only quantitative record of the five, Holail and colleagues pair LuoJia3-01 satellite imagery with deep-learning damage detection to quantify the destruction of Gaza in near-real time: 15.4\% of structures destroyed, 18.7\% severely damaged, and over 3,700 missile craters mapped across five governorates. Its significance is double. Substantively, it defines and measures ``urban annihilation'' as a detectable transformation of the built environment. Methodologically, it demonstrates the sensing stack's documentary afterlife: the same class of infrastructure used for targeting can be turned to accountability — the counter-forensic possibility taken up in the discussion (\S\ref{sec:policy-implications}).

\textbf{The synthesis: \textcite{lotfijam2025}.} Lotfi-Jam's ``realtime urbanism'' is the only one of the five to engage all four framework themes. Its argument: the capacity ``to sense, model, and intervene with minimal delay'' is a single operational condition shared by military, entertainment, and urban systems — ``Realtime is the shared operational condition that enables all three.'' Latency becomes a governing logic that ``naturalize[s] control as responsiveness, and collapse[s] deliberation into automation.'' Read against the framework, this is Arrow's frictionlessness and Deleuze's modulation restated at the level of infrastructure: when sensing and intervention converge to near-zero delay, the distinction between managing a city and striking it becomes a parameter setting — and the AI-assisted kill chain is the proof.

Against 76 destruction records and 117 epistemic-authority records, these five constitute the only sustained bridges. Four of the five are theoretical; four postdate 2021; and the theoretical four lean heavily on investigative journalism for their operational detail. The urbicide canon theorises destruction but barely touches its algorithmisation; the algorithmic-governance literature theorises modulation but stops short of the kill chain. The intersection — algorithmically mediated urbicide — is nearly empty. This is the dissertation's central empirical finding, and it is a finding about the literature itself.
